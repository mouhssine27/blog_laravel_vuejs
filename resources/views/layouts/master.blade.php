      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Languages</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="{{ route('change.lang', 'fr') }}">Francais</a></li>
              <li><a href="{{ route('change.lang', 'en') }}">English</a></li>
            </ul>
          </li>
          @guest
          <li class="dropdown"><a href="#"><span>Connexion</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
          ...
          <li class="dropdown"><a href="#"><span>{{ Auth::user()->name }}</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              @if(session()->get('lang')==='fr')
              <li><a href="#" onclick="document.getElementById('formLogout').submit();">Se déconnecter</a></li>
              @else
