            ...
            <div class="row">
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        ...
                        <div class="post-meta"><span class="date">{{ $post->category->name_en}}</span> <span
                                class="mx-1">&bullet;</span> <span>{{ $post->created_at->diffForHumans() }}</span>
                        </div>
                        @else
                        <div class="post-meta"><span class="date">{{ $post->category->name_fr}}</span> <span
                            class="mx-1">&bullet;</span> <span>{{ $post->created_at->diffForHumans() }}</span>
                        </div>
                        @endif
                        @if(session()->get('lang')==='en')
                        <h1 class="mb-5">{{ $post->title_en }}</h1>
                        @else
                        <h1 class="mb-5">{{ $post->title_fr }}</h1>
                        @endif

                        {{-- <p><span class="firstcharacter">L</span>{{ $post->body_en }}</p> --}}

                        <figure class="my-4">
                            <img src="{{ $post->photo }}" alt="" style="height: 550px;" class="img-fluid">
                        </figure>
                        <div class="d-flex justify-content-between">
                          @if(isset($previousPost))
                                    @if(session()->get('lang')==='en')
                                    <div>
                                        <a href="{{ route('posts.show',$previousPost) }}" class="btn btn-dark"> Previous</a>
                                    </div>
                                    @else
                                    <div>
                                        <a href="{{ route('posts.show',$previousPost) }}" class="btn btn-dark"> Précédent</a>
                                    </div>
                                    @endif
                          ...
                          @if(isset($nextPost))
                                    @if(session()->get('lang')==='en')
                                    <div>
                                        <a href="{{ route('posts.show',$nextPost) }}" class="btn btn-dark"> Next</a>
                                    </div>
                                    @else
                                    <div>
                                        <a href="{{ route('posts.show',$nextPost) }}" class="btn btn-dark"> Suivant</a>
                                    </div>
                                    @endif
                          @endif
                      </div>
                    ...
                    <div class="comments">
                            ...
                            <div class="flex-grow-1 ms-2 ms-sm-3">
                                ...
                                <div class="comment-replies bg-light p-3 mt-3 rounded">
                                    ...
                                    <div class="reply d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="{{ asset('assets/img/person-4.jpg') }}"
                                                    alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                                    ...
                                    <div class="reply d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="{{ asset('assets/img/person-3.jpg') }}"
                                                    alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                        ...
                        <div class="comment d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img class="avatar-img" src="{{ asset('assets/img/person-2.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
